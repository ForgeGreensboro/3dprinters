...
#define MANUAL_Z_HOME_POS 301.4 // For delta: Distance between nozzle and print surface after homing.
...
#define Z_PROBE_OFFSET {0,-30,-.4,0}  // (0, 14, -6.5, 0){24.6,-21,0,0}{24.6,-21,0,0} X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.(0,19,-8,0)
